...
\crlf
\useURL[url16][http://resume.eirikenger.xyz/resume.pdf][][pdf
version]\from[url16] •
\useURL[url17][http://resume.eirikenger.xyz/resume.docx][][doc
version]\from[url17] •
\useURL[url18][http://resume.eirikenger.xyz/resume.rft][][rtf
version]\from[url18] •
\useURL[url19][http://resume.eirikenger.xyz/resume.html][][html
version]\from[url19]
\stopblockquote

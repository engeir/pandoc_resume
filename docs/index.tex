...
\crlf
\useURL[url16][http://resume.eirikenger.xyz/index.pdf][][pdf
version]\from[url16] •
\useURL[url17][http://resume.eirikenger.xyz/index.docx][][doc
version]\from[url17] •
\useURL[url18][http://resume.eirikenger.xyz/index.rft][][rtf
version]\from[url18] •
\useURL[url19][http://resume.eirikenger.xyz][][html version]\from[url19]
\stopblockquote

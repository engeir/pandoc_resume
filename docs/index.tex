...
\startdescription{Open Source}
  ...
  {\bf \useURL[url8][https://github.com/engeir/northern-lights-forecast][][northern-lights-forecast]\from[url8]}
  and
  {\bf \useURL[url9][https://ncdump-rich.readthedocs.io/][][ncdump-rich]\from[url9]}
  which are both published on
  \useURL[url10][https://pypi.org/][][PyPI]\from[url10].
  ...
  {\bf \useURL[url11][https://github.com/Naheel-Azawy/stpv][][stpv]\from[url11]}
  which is a general previewing tool to be used within the terminal, for
  example with the file manager
  \useURL[url12][https://godoc.org/github.com/gokcehan/lf][][lf]\from[url12].
\stopdescription
